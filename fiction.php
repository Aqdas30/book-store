...
if(isset($_GET['categoryid']))
{
    ...
    $stmt=$conn->prepare("SELECT * From `book` join `bookcategories` on bookcategories.categoryid =book.categoryid where bookcategories.categoryid=? ");
...
<section id="header">
  ...
  <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton1" class="active" data-bs-toggle="dropdown" aria-expanded="false">
   Categories
  </button>
...
<section id="product" class="section-p1">
        ...
        <div class="product-container">
            <!-- <a href="single_Product.php" class="pro-link">  -->
            <?php 
                    while($r= $book->fetch_assoc()){
